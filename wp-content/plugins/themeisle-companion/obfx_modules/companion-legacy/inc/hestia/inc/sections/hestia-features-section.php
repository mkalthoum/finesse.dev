...
if ( ! function_exists( 'hestia_features' ) ) :
	...
	function hestia_features( $is_shortcode = false ) {
		...
		?>
		<section class="hestia-features fullscreen-feature <?php echo esc_attr( $wrapper_class ); ?>" id="features" data-sorder="hestia_features">
			<?php
...
<div  class="bounce feature-arrow"><a class="fa fa-feature fa-arrow-down fa-2x" href="#subscribe"></a></div>
			</div>
	...
	if ( ! empty( $hestia_features_content ) ) :
		...
		if ( ! empty( $hestia_features_content ) ) {
			...
			foreach ( $hestia_features_content as $features_item ) :
				...
				?>
				<div class="col-xs-12 col-sm-6 <?php echo apply_filters( 'hestia_features_per_row_class','col-md-4' ); ?> feature-box">
