...
class Hestia_About_Section extends Hestia_Abstract_Main {
	...
	private function hook_section() {
		$section_priority = apply_filters( 'hestia_section_priority', 10, 'hestia_about' );
	...
	public function render_section() {
		...
		if ( ! empty( $hestia_frontpage_featured ) ) {
			...
			<section class="hestia-about <?php echo esc_attr( $class_to_add ); ?>" id="finesse" data-sorder="hestia_about" style="min-height: 700px;" <?php echo wp_kses_post( $section_style ); ?>>
